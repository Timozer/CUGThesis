...
\begin{ttab}{论文相关信息命令}{tab:cugthesisinfocmds}
    \begin{tabular}{lll}
        ...
        \tcodeinline{tex}{\cugthesisdegree}  & 学位     & \tcodeinline{tex}{\cugthesisdegree{cndegree}{endegree}} \\
...
\begin{minted}{tex}
    ...
    \cugthesisdegree{}{Test Degree}
    \cugthesisteacher{蔡之华}{Zhihua Cai}
    \educatingunit{计算机学院}
    \cugthesisdate{2018}{3}
\end{minted}

注意: 命令 \tcodeinline{tex}{\cugthesisdegree} 用于专业和授予学位名字不同的场景, 比如:
专业是 应用经济学(Applied Economics), 授予的学位是 经济学(Economics).
其中的参数如果为空, 则取 \tcodeinline{tex}{\cugthesismajor} 中 cn, en 对应的字符串.
...
2. 增加 \tcodeinline{tex}{\cugthesisdegree} 命令，该命令主要用于某些专业和其所授予的学位名字不同，
比如: 专业是 应用经济学(Applied Economics), 授予的学位是 经济学(Economics).
该命令具体用法可参考 example.tex 文件.
